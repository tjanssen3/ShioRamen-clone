...
func (in *KubeObjectProtectionSpec) DeepCopyInto(out *KubeObjectProtectionSpec) {
	*out = *in
	if in.ResourceCaptureOrder != nil {
		...
		*out = make([]ResourceCaptureInstance, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ResourceRecoveryOrder != nil {
		...
		*out = make([]ResourceRestoreInstance, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceCaptureInstance) DeepCopyInto(out *ResourceCaptureInstance) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceCaptureInstance.
func (in *ResourceCaptureInstance) DeepCopy() *ResourceCaptureInstance {
	if in == nil {
		return nil
	}
	out := new(ResourceCaptureInstance)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceRestoreInstance) DeepCopyInto(out *ResourceRestoreInstance) {
	*out = *in
	if in.IncludedResources != nil {
		in, out := &in.IncludedResources, &out.IncludedResources
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceRestoreInstance.
func (in *ResourceRestoreInstance) DeepCopy() *ResourceRestoreInstance {
	if in == nil {
		return nil
	}
	out := new(ResourceRestoreInstance)
	in.DeepCopyInto(out)
	return out
}
